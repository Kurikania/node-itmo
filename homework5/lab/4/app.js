...
app.get('/', (req, res, next)=> { /*render – наполняем данными шаблон и отправляет полученный таким образом файл вёрстки клиенту: index – это файл шаблона index.mustache; { title: 'First experence with mustache!' } – объект из которого берутся данные в шаблон*/
